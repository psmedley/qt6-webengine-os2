...
//    IS_OPENBSD / IS_QNX / IS_SOLARIS / IS_WIN / IS_OS2
...
//              or MAC or NACL or NETBSD or OPENBSD or QNX or SOLARIS or OS/2
...
// more specific macro.
    ...
    defined(OS_SOLARIS) || defined(OS_ZOS) || defined(OS_OS2)
#define OS_POSIX 1
#endif
...
#if defined(OS_OS2)
#define BUILDFLAG_INTERNAL_IS_OS2() (1)
#else
#define BUILDFLAG_INTERNAL_IS_OS2() (0)
#endif
