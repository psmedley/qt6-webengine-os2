...
#if BUILDFLAG(IS_CHROMEOS) || BUILDFLAG(IS_OS2) || (BUILDFLAG(IS_LINUX) && defined(USE_CUPS))
...
#endif  // BUILDFLAG(IS_CHROMEOS) || BUILDFLAG(IS_OS2) || (BUILDFLAG(IS_LINUX) && defined(USE_CUPS))
